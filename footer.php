      ...
      <div class="container-fluid">
        ...
        <div class="container col-12 col-md-9">
          ...
          <div class="text-section">
            <strong
              >مـهمـتریـن هدف مجموعه ســـایبــــریشـــــــو نقش بستن لبخند رضایت
              بر لبان مخاطب است و چیزی غیر از این برای ما خوشایند نخواهد بود. در
              مسیر تحقق این هدف بالا، از هیچ تلاشی دریغ نخواهیم کرد. با تجربه ای
              از اوایل دهه 80 ؛ ســــایبـــــــریشــــــــــو، الان
              وقتشـــــه…</strong
            >
          </div>
          <div class="main-section d-flex">
            <div class="enamad col-12 col-md-2">
              ...
              <a href=""><img src="<?php echo get_template_directory_uri() . '/assets/img/enamad.png' ?>" alt="enamad" /></a>
              <div class="samandehi-2">
                <a href=""><img src="<?php echo get_template_directory_uri() . '/assets/img/samandehi.png'?>" alt="samandehi" /></a>
              </div>
            </div>
            ...
            <div class="contact col-12 col-md-8">
              ...
              <div class="footer d-flex">
                <div class="col-12 col-md-6 location">
                  ...
                  <div class="text">
                    <p>تهران،بلوارنلسون ماندلا (جردن)، مهــراد، بن بست زوار</p>
                  </div>
                </div>
                <div class="col-12 col-md-6 telephone">
                  <div class="number">
                    <pre>021     880    68    221</pre>
                    <pre>0919     730    3855</pre>
                  </div>
                  <div>
