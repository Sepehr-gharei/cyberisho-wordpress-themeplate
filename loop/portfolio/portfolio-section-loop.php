...
<div id="portfolio-loop">
    <?php if ($loop->have_posts()): ?>
                    ...
                    <div class="text-field">
                        <div class="website">
                            ...
                            <div class="website-name">
                                ...
                                <p><?php
                                echo $project_name = get_post_meta(get_the_ID(), '_project_url', true);
                                ?></p>
                            </div>
                        </div>
                        <div class="about-website">
                            <p>نوع سایت : <?php
                            echo $project_name = get_post_meta(get_the_ID(), '_site_type', true);
                            ?></p>
                            <p>مدت زمان انجام : <?php
                            echo $project_name = get_post_meta(get_the_ID(), '_duration', true);
                            ?></p>
                            <p>موقعیت : <?php
                            echo $project_name = get_post_meta(get_the_ID(), '_position', true);
                            ?></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="content-wrapper">
                            <div class="row">
                                <div class="section">
                                    ...
                                    // عکس کوچک
                                    $thumbnail_id = get_post_meta($post_id, '_thumbnail_image_id', true);
                                    $thumbnail_title = get_post_meta($post_id, '_thumbnail_title', true);

                                    // عکس بزرگ
                                    $large_id = get_post_meta($post_id, '_large_image_id', true);
                                    $large_title = get_post_meta($post_id, '_large_title', true);
                                    ?>
                                    ...
                                    <div class="wrapper-container">
                                        ...
                                        <div class="wrapper w30">
                                            <div class="content">
                                                <div class="image-container">
                                                    <?php if ($thumbnail_id): ?>
                                                        <?php echo wp_get_attachment_image($thumbnail_id, 'medium', false, ['alt' => esc_attr($thumbnail_title), 'class' => 'responsive-img']); ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wrapper w70">
                                            <div class="content">
                                                <div class="image-container">
                                                    <?php if ($large_id): ?>
                                                        <?php echo wp_get_attachment_image($large_id, 'full', false, ['alt' => esc_attr($large_title), 'class' => 'responsive-img']); ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <div class="error">محتوایی یافت نشد.</div>
    <?php endif; ?>

    <!-- Pagination با AJAX -->
    <div class="pagination animated-section" id="pagination">
        <?php
