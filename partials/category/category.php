      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-8 image-preview">
            ...
            <?php get_template_part('loop/category/blog-title-loop', 'blog-title-loop') ?>
            </div>
          </div>
          <div class="col-12 col-md-4 section">
            <div class="wrapper">
              ...
              <div class="content-wrapper">
                ...
                <?php get_template_part('loop/category/blog-title-category-loop', 'blog-title-category-loop') ?>
...
<div class="blog-section">
  <div class="container">
    <div class="row">
      <?php
      get_template_part('loop/category/blog-section-loop', 'blog-section-loop')
        ?>
    </div>
  </div>
</div>
