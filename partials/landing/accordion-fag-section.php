...
$faq_items = get_post_meta(get_the_ID(), '_landing_faq_items', true);
$faq_items_data = !empty($faq_items) ? json_decode($faq_items, true) : array();
?>
<section class="accordion-fag-section accordion-fag-landing-section">
  <div class="container">
    <div class="title-container">
      <h2>سوالات متداول</h2>
    </div>
    <div class="accordion-container">
      <?php if (!empty($faq_items_data)): ?>
        <?php foreach ($faq_items_data as $item): ?>
        ...
        <div class="accordion-item d-flex">
          <div class="col-12 wrapper-text">
            <button class="accordion-header">
              ...
              <div class="icon-arrow">
                <svg viewBox="0 0 218 146" version="1.1" xmlns="http://www.w3.org/2000/svg">
                  <g id="#000000ff">
                    <path fill="var(--normal-text-color)" opacity="1.00"
            ...
            <div class="accordion-content">
              <p>
                لطفاً سوالات متداول را از پنل مدیریت اضافه کنید.
              </p>
            </div>
          </div>
        <?php endif; ?>
